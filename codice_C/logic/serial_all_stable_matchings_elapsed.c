...
struct ResultsList* all_stable_matchings_times(int n, int* men_preferences, int* women_preferences, int* time_gale_shapley, int* time_find_all_rotations, int* time_build_graph, int* time_recursive, int* time_total){
	uint64_t start_time;
    uint64_t end_time;
